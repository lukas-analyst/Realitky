...
USING(
    SELECT
        ...
        COALESCE(TRY_CAST(REGEXP_REPLACE(listing_details_idnes.cena, '[^0-9]', '') AS DECIMAL(15,2)), 0) AS price_amount,
        TRY_CAST(ROUND(
            ...
            2
        ) AS DECIMAL(10,2)) AS price_per_sqm,
        CASE
        ...
        listing_details_idnes.reserved AS reserved,
        listing_details_idnes.status AS status,
        :cleaner AS src_web,
