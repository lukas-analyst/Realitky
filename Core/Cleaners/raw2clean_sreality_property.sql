  ...
  USING (
    ...
    CASE
      ...
      WHEN listing_details_sreality.podlazi LIKE '%z celkem%' 
        THEN TRY_CAST(REGEXP_EXTRACT(listing_details_sreality.podlazi, 'z celkem ([0-9]+)', 1) AS INT)
      ELSE -1
    ...
    COALESCE(listing_details_sreality.rok_rekonstrukce, -1) AS last_reconstruction_year,
    ...
    IF(listing_details_sreality.voda IS NOT null, 2, 1) AS property_water_supply_id,
